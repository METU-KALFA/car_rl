...
: ${AMENT_CURRENT_PREFIX:="/root/sam_bot_description/src/joint_control/install/joint_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/joint_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/joint_control/environment/path.sh"
