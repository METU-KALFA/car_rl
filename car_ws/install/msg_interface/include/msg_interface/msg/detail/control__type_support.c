...
#include <stddef.h>
#include "msg_interface/msg/detail/control__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  msg_interface__msg__Control__init(message_memory);
}

void Control__rosidl_typesupport_introspection_c__Control_fini_function(void * message_memory)
{
  msg_interface__msg__Control__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Control__rosidl_typesupport_introspection_c__Control_message_member_array[2] = {
  {
    "vx",  // name
    ...
    offsetof(msg_interface__msg__Control, vx),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_interface__msg__Control, vy),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Control__rosidl_typesupport_introspection_c__Control_message_members = {
  ...
  2,  // number of fields
  sizeof(msg_interface__msg__Control),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_interface, msg, Control)() {
