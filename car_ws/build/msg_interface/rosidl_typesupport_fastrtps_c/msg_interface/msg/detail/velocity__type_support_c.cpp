...
#include "msg_interface/msg/detail/velocity__rosidl_typesupport_fastrtps_c.h"
...
using _Velocity__ros_msg_type = msg_interface__msg__Velocity;
...
size_t get_serialized_size_msg_interface__msg__Velocity(
  const void * untyped_ros_message,
...
static uint32_t _Velocity__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_interface__msg__Velocity(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_interface
size_t max_serialized_size_msg_interface__msg__Velocity(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_msg_interface__msg__Velocity(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_interface, msg, Velocity)() {
