...
#include "msg_interface/msg/detail/velocity__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msg_interface::msg::Velocity & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_interface::msg::Velocity & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const msg_interface::msg::Velocity *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_interface::msg::Velocity *>(
    untyped_ros_message);
...
{
  return &msg_interface::msg::typesupport_fastrtps_cpp::_Velocity__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interface, msg, Velocity)() {
  return &msg_interface::msg::typesupport_fastrtps_cpp::_Velocity__handle;
}
