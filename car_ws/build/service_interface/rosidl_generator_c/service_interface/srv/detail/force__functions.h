...
#ifndef SERVICE_INTERFACE__SRV__DETAIL__FORCE__FUNCTIONS_H_
#define SERVICE_INTERFACE__SRV__DETAIL__FORCE__FUNCTIONS_H_
...
/// Create srv/Force message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * service_interface__srv__Force_Request__init().
...
/// Destroy srv/Force message.
/**
 * It calls
 * service_interface__srv__Force_Request__fini()
...
/// Initialize array of srv/Force messages.
/**
...
/// Finalize array of srv/Force messages.
/**
 * It calls
 * service_interface__srv__Force_Request__fini()
...
/// Create array of srv/Force messages.
/**
 * It allocates the memory for the array and calls
 * service_interface__srv__Force_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Force messages.
/**
 * It calls
 * service_interface__srv__Force_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * service_interface__srv__Force_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_service_interface
...
/**
 * It calls
 * service_interface__srv__Force_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_service_interface
...
/**
 * It allocates the memory for the array and calls
 * service_interface__srv__Force_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_service_interface
...
/**
 * It calls
 * service_interface__srv__Force_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SERVICE_INTERFACE__SRV__DETAIL__FORCE__FUNCTIONS_H_
