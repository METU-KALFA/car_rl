...
class Metaclass_Location(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'service_interface.srv.Location')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from service_interface.srv import _location
...
class Location(metaclass=Metaclass_Location):
    from service_interface.srv._location import Location_Request as Request
    from service_interface.srv._location import Location_Response as Response
