...
static const _CurveCoeffs_type_support_symbol_names_t _CurveCoeffs_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carrl_interface, msg, CurveCoeffs)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carrl_interface, msg, CurveCoeffs)),
  }
};
...
{
  return &::carrl_interface::msg::rosidl_typesupport_cpp::CurveCoeffs_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, carrl_interface, msg, CurveCoeffs)() {
  return get_message_type_support_handle<carrl_interface::msg::CurveCoeffs>();
}
